...
#Consider a corpus of documents and a dictionary of terms contain all 
#the words that appear in the documents. The term-document matrix then is 
#a two-dimensional matrix whose rows are the terms and columns are the documents, 
...
## Test linear regression to predict
## ok prove to be very poor
...
#print(X_test)
y_pred = regr.predict(testing_data)
...
#print('Precision score: ', precision_score(y_test, predictions,pos_label='ham'))
